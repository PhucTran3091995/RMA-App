...
import { getRmaStats, getRmaStatsByDate } from "../api/rmaApi";
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <select
                        value={range}
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setRange(e.target.value as '7d' | '30d' | '90d')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard
                    ...
                    icon={AlertCircle}
                    color="bg-red-500"
                    onClick={() => navigate('/rmas?status=IN')}
                />
                <StatCard
                    title="Processing"
                    ...
                    icon={Clock}
                    color="bg-yellow-500"
                    onClick={() => navigate('/rmas?status=Processing')}
                />
                <StatCard
                    title="OUT"
                    ...
                    icon={CheckCircle}
                    color="bg-green-500"
                    onClick={() => navigate('/rmas?status=OUT')}
                />
            </div>
